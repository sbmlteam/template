Template for repositories by the SBML Team<img width="14%" align="right" src=".graphics/sbml-badge.svg">
===================================================
...
[![Latest release](https://img.shields.io/github/v/release/sbmlteam/template.svg?style=flat-square&color=b44e88)](https://github.com/sbmlteam/template/releases)
...
This repository is a GitHub template repostory for creating software project repositories by the SBML Team.  The [associated wiki page](https://github.com/sbmlteam/template/wiki/Using-this-template-repo) explains how to use the template repository.
...
Acknowledge the organizations that supported this work.

In addition, if your work relies on software libraries, or was inspired by looking at other work, it is appropriate to acknowledge this intellectual debt too.

<div align="center">
  <a href="https://www.caltech.edu">
    <img width="100" src=".graphics/caltech-round.png">
  </a>
</div>
